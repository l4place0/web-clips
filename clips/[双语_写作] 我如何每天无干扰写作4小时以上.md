...
1. **先用低门槛记录建立材料感。** 写作起点是晨间或晚间日记：记录当天所见、感受、问题和次日目标。讲者把这称为从“脑中的想法”走到“纸上已有内容”的过渡，而不是一开始就要求自己写出可发布的故事。{{frame:1}}
...
讲者转述手写的一种价值，是它减少了电子邮件、视频和其他数字选项的可得性；这张帧只是该个人偏好的语义锚点，并未展示纸笔、环境或实际无干扰状态。{{frame:5}}
